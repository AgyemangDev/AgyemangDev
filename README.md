...
Je suis étudiant en Master à **JUNIA ISEN, Lille** (boursier Erasmus+) et **co-fondateur & CTO de HostelHubb** — une plateforme mobile en production que j'ai fait passer de 500 à plus de 5 000 utilisateurs actifs.
...
- 🏗️ Actuellement en train de construire HostelHubb tout en étudiant à JUNIA ISEN
...
> **CTO & Co-fondateur** | `React Native` `Angular` `Node.js` `Supabase` `PostgreSQL` `Paystack` `GitHub Actions`

Marketplace ghanéen dédié à l'hébergement, au stockage et au transport étudiant — développé de zéro jusqu'à la production.

| Métrique | Résultat |
|--------|--------|
| 👥 Utilisateurs actifs | **5 000+** |
| 📦 Mises en production | **1000+** |
| 📈 Hausse de l'engagement | **+60%** |
| ⚡ Temps de chargement | **4,2s → 1,8s** |
| 🚀 Temps de déploiement | **2 heures → 15 minutes** |
| 🧪 Couverture de tests | **80%+** |

Développé : recommandation par IA (filtrage collaboratif + NLP, +45% de précision de correspondance) · intégration complète du paiement Paystack · notifications push en temps réel · tableau de bord admin avec rôles · pipeline CI/CD App Store + Play Store
...
> `Python` `Tkinter/PyQt` `Simulations physiques`
...
**Co-fondateur & CTO — HostelHubb** *(2024 – Présent)*
...
> **CTO & Co-Founder** | `React Native` `Angular` `Node.js` `Supabase` `PostgreSQL` `Paystack` `GitHub Actions`
...
>  `Angular`  `Python (FAST API)` `Tkinter/PyQt` `Physics Simulations` 
